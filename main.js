...
const projects = {
    'social-media': import.meta.glob('/public/assets/projects/social-media/*.{png,jpg,jpeg,webp,svg}', { eager: true }),
    'flyers': import.meta.glob('/public/assets/projects/flyers/*.{png,jpg,jpeg,webp,svg}', { eager: true }),
    'thumbnails': import.meta.glob('/public/assets/projects/thumbnails/*.{png,jpg,jpeg,webp,svg}', { eager: true }),
    'other': import.meta.glob('/public/assets/projects/other/*.{png,jpg,jpeg,webp,svg}', { eager: true }),
};
...
// ==========================================
const clientImages = import.meta.glob('/public/assets/clients/*.{png,jpg,jpeg,svg}', { eager: true });
